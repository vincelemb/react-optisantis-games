...
const HeartBeat: React.FC<HeartBeatProps> = (props: React.PropsWithChildren<HeartBeatProps>) =>{
    ...
    return(
        <React.Fragment>
                ...
                <HeartSvg svgAnimationState={props.playingState && props.playingState} customSvgClass={`_absolute ${animatedClass}-${props.playingStep && props.playingStep}`} svgHeight="100%" svgWidth="100%"></HeartSvg>
