...
const pathToProjects = resolve(__dirname, '../projects/memory/public/assets/img');
const pathToAssets = resolve(__dirname, '../projects/memory/src/assets/images.json');
const json = {};
...
try {
    ...
    writeFileSync(join(pathToAssets), JSON.stringify(json), { encoding: 'utf8' });
